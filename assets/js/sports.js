$.ajax({
  ...
  url: 'https://gnews.io/api/v3/topics/sports?&token=4a25a94bf5010d7c44d96f6331cab821',
  method: "GET",
  dataType: "json",
  success: function(data){
    let output = "";
    fetch('https://gnews.io/api/v3/topics/sports?&token=4a25a94bf5010d7c44d96f6331cab821')
